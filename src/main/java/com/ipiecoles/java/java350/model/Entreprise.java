...
public final class Entreprise {
	...
	private final static Map<NiveauEtude, Double> COEFF_SALAIRE_ETUDES = new EnumMap<>(NiveauEtude.class);
	...
	static {
		getCoeffSalaireEtudes().put(NiveauEtude.CAP, 1.0);
		getCoeffSalaireEtudes().put(NiveauEtude.BAC, 1.1);
		getCoeffSalaireEtudes().put(NiveauEtude.BTS_IUT, 1.2);
		getCoeffSalaireEtudes().put(NiveauEtude.LICENCE, 1.2);
		getCoeffSalaireEtudes().put(NiveauEtude.MASTER, 1.4);
		getCoeffSalaireEtudes().put(NiveauEtude.INGENIEUR, 1.6);
		getCoeffSalaireEtudes().put(NiveauEtude.DOCTORAT, 1.7);
